...
| 22 | [`2026-09-07-200123Z-null-placeholder-medicaid-ids.sql`](2026-09-07-200123Z-null-placeholder-medicaid-ids.sql) | Guardedly replace three recognized DEV placeholder Medicaid identifiers with `NULL`; never merges/deletes clients — **pending explicit approval and DEV apply** |
