...
| 24 | [`2026-09-12-060419Z-multistate-rule-foundation.sql`](2026-09-12-060419Z-multistate-rule-foundation.sql) | Add multi-state ownership, payer/enrollment, immutable effective rule versions, and durable session resolution snapshots — **PENDING APPLY**; additive and depends only on the existing `User`, `Client`, and `Session` tables |
...
| [`2026-09-12-060419Z-multistate-rule-foundation.sql`](2026-09-12-060419Z-multistate-rule-foundation.sql) | Additive multi-state organization/location/jurisdiction/payer/enrollment authority plus immutable effective rule versions and content-addressed session decision snapshots — **PENDING APPLY** |
