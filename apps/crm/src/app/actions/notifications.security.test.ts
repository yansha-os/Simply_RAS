...
describe('CRM notification module boundary', () => {
  it('keeps producers out of every Server Action export module', () => {
    ...
    const actionPath = join(
      process.cwd(),
      'apps/crm/src/app/actions/notificationActions.ts'
    );
...
describe('CRM notification producer security', () => {
  it.each([
    '//evil.example/phish',
    'https://evil.example/phish',
    'https://crm.example.test.evil.example/phish',
  ...
  it.each([
    '/client/abc?mode=billing',
    'https://crm.example.test/portal-clinical/notes',
    'https://hrm.example.test/rbt/payroll',
...
describe('CRM notification recipient actions', () => {
